...
function playAudio() {
    ...
    // !Add 1st text
    setTimeout(function () {
        msg.innerText = "Sablog gaana start kro🤗";
    }, 2000);
    // !Add 2nd text
    initialize();
    setTimeout(function () {
        msg.innerText = "Taaliyan👏";
        // !Add clapping audio
        ...
        .then(stream => {
            ...
            function checkVolume() {
                ...
                // *Changing flames according to mic volume
                    ...
                    setTimeout(function () {
                        msg.innerText = "Jor se phuk maaro🤣";
                    }, 500);
                    // *Show flame images
                ...
                if (isTrue) {
                    ...
                    setTimeout(function () {
                        msg1.innerHTML = "<b>Happy Birthday Kaushika</b>😘";
                    ...
                    setTimeout(function () {
                        msg6.innerText = "\nAur Pareshan krne ke lye sorry 😭";

                    }, 11000);
                    setTimeout(function () {
                        msg7.innerText = "\nAur hann cake khana mat bhulna🎂";

                    }, 11000);
                    setTimeout(function () {
                        msg8.innerText = "Best wishes from Venkatesh🎂";

                    }, 14500);
                    setTimeout(function () {
                        msg9.innerHTML = "<b>Universe</b>🌏";
            ...
            setTimeout(function () {
                msg.innerText = "Kaushika blow the candles!!!";
            }, 25000);
